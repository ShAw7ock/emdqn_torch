...
def parse_args():
    ...
    # Environment
    parser.add_argument("--env", type=str, required=True, help="Gym Env name, MountainCar-v0 ...")
    parser.add_argument("--seed", type=int, default=1, help="random seed")
    # DQN Parameters
    parser.add_argument("--hidden_dims", type=int, default=10, help="hidden dimensions for MLP networks")
    ...
    parser.add_argument("--n_iterations", type=int, default=int(20000), help="total number of training iterations")
    ...
    parser.add_argument("--ec_buffer_size", type=int, default=int(2e3), help="episodic memory size")
    parser.add_argument("--ec_latent_dim", type=int, default=2, help="dimensions for random project method")
